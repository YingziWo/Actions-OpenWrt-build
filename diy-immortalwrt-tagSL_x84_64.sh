...
#luci-app-store
###git_sparse_clone master https://github.com/kiddin9/openwrt-packages luci-app-store                 ###kiddin9 在2024.10.03不明原因删库。更换原始的源。
...
git_sparse_clone master https://github.com/kenzok8/small v2dat
