...
git_sparse_clone 4.78-2 https://github.com/xiaorouji/openwrt-passwall luci-app-passwall     #原始作者仓库源 4.78-2是稳定版，在lede20230609版上运行正常，2024.10.05作者推出4.78-3版本,但编译的固件总节点分流无效，4.78-2正常。
